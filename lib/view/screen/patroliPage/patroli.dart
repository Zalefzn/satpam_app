...
import 'package:sigapp_app/view/screen/patroliPage/patroliList.dart';

class PatroliPage extends StatefulWidget {
  const PatroliPage({Key? key}) : super(key: key);

  @override
  State<PatroliPage> createState() => _Patroli();
}

class _Patroli extends State<PatroliPage> {
  @override
